    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-oif-blue to-oif-blue-light px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-oif-blue-100 text-sm mt-1">Votre assistant en Suivi-Évaluation — OIF</p>
        </div>

        <div className="card">
          <h2 className="text-xl font-semibold text-oif-blue mb-6">Connexion</h2>
          ...
          <p className="text-sm text-oif-gray-500 text-center mt-6">
            ...
            <Link href="/signup" className="text-oif-blue-light font-medium hover:underline">
              Créer un compte
            </Link>
          </p>
        </div>
